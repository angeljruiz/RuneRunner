...
public class Craft extends Task<ClientContext>
{
    ...
    private Tile currentPortalTile = airPortalTile;
    private Tile currentAltarTile = airAltarTile;
    private int currentAltar = airAltarID;
    private int currentPortal = airPortal;
