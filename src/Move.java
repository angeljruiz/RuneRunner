...
public class Move extends Task<ClientContext>
{
    ...
    private int currentAltar = varAltar;
    private TilePath currentPath = ctx.movement.newTilePath(tileVarEar);
    private TilePath currentPathRev = ctx.movement.newTilePath(tileVarEar).reverse();
    private Tile currentAreaEnd = varEnd;
