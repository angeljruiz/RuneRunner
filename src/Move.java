...
public class Move extends Task<ClientContext>
{
    ...
    private int currentAltar = alAltar;
    private TilePath currentPath = ctx.movement.newTilePath(tileAlFir);
    private TilePath currentPathRev = ctx.movement.newTilePath(tileAlFir).reverse();
    private Tile currentAreaEnd = alEnd;
